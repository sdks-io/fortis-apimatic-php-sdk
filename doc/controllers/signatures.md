...
```php
function createanewsignaturerecord(V1SignaturesRequest $body, ?array $expand = null): ApiResponse
```
...
| `expand` | [`?(string(Expand34)[])`](../../doc/models/expand-34.md) | Query, Optional | Most endpoints in the API have a way to retrieve extra data related to the current record being retrieved. For example, if the API request is for the accountvaults endpoint, and the end user also needs to know which contact the token belongs to, this data can be returned in the accountvaults endpoint request.<br><br>**Constraints**: *Unique Items Required* |

## Response Type

This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `getResult()` method on this instance returns the response data which is of type [`ResponseSignature`](../../doc/models/response-signature.md).
...
$signaturesController = $client->getSignaturesController();
$apiResponse = $signaturesController->createanewsignaturerecord($body);
...
| `fields` | [`?(string(Field45)[])`](../../doc/models/field-45.md) | Query, Optional | You can use any `field_name` from this endpoint results to filter the list of fields returned on the response. |

## Response Type

This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `getResult()` method on this instance returns the response data which is of type [`ResponseSignaturesCollection`](../../doc/models/response-signatures-collection.md).
...
$signaturesController = $client->getSignaturesController();
$apiResponse = $signaturesController->listallsignaturesrecord(
    $page,
    $order,
    $filterBy
);
...
if ($apiResponse->isSuccess()) {
    echo 'ResponseSignaturesCollection:';
    var_dump($apiResponse->getResult());
} else {
    $error = $apiResponse->getResult();
    var_dump($error);
...
$signaturesController = $client->getSignaturesController();
$apiResponse = $signaturesController->viewsinglesignaturerecord($signatureId);
