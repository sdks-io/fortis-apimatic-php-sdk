...
| `challengeWindowSize` | [`?string(ChallengeWindowSize)`](../../doc/models/challenge-window-size.md) | Optional | - | getChallengeWindowSize(): ?string | setChallengeWindowSize(?string challengeWindowSize): void |
