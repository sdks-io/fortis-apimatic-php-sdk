...
| `freightAmount` | `?int` | Optional | Freight or shipping portion of the total transaction amount ,Can accept Two (2) decimal places.<br><br>**Constraints**: `>= 0`, `<= 999999999900` | getFreightAmount(): ?int | setFreightAmount(?int freightAmount): void |
