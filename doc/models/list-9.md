...
| `id` | `?string` | Optional | System generatedPaylink Id<br><br>**Constraints**: *Pattern*: `^(([0-9a-fA-F\-]{24,36})\|(([0-9a-fA-F]{8})-(([0-9a-fA-F]{4}\-){3})([0-9a-fA-F]{12})))$` | getId(): ?string | setId(?string id): void |
| `statusId` | `?bool` | Optional | (DEPRECATED) Status Id | getStatusId(): ?bool | setStatusId(?bool statusId): void |
| `statusCode` | [`?int(StatusCode12Enum)`](../../doc/models/status-code-12-enum.md) | Optional | The various statuses of the paylink.  0=Unpaid \| 1=Paid | getStatusCode(): ?int | setStatusCode(?int statusCode): void |
| `active` | `?bool` | Optional | Paylink is still Active | getActive(): ?bool | setActive(?bool active): void |
