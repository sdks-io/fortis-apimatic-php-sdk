...
| `merchantRiskIndicator` | [`?MerchantRiskIndicator1`](../../doc/models/merchant-risk-indicator-1.md) | Optional | - | getMerchantRiskIndicator(): ?MerchantRiskIndicator1 | setMerchantRiskIndicator(?MerchantRiskIndicator1 merchantRiskIndicator): void |
...
| `transactionType` | [`?string(TransactionType)`](../../doc/models/transaction-type.md) | Optional | - | getTransactionType(): ?string | setTransactionType(?string transactionType): void |
...
| `amountInd` | [`?string(AmountInd)`](../../doc/models/amount-ind.md) | Optional | - | getAmountInd(): ?string | setAmountInd(?string amountInd): void |
