...
| `cauSummaryStatusId` | [`?int(CauSummaryStatusId)`](../../doc/models/cau-summary-status-id.md) | Optional | - | getCauSummaryStatusId(): ?int | setCauSummaryStatusId(?int cauSummaryStatusId): void |
...
| `paymentMethod` | [`?string(PaymentMethod16)`](../../doc/models/payment-method-16.md) | Optional | - | getPaymentMethod(): ?string | setPaymentMethod(?string paymentMethod): void |
