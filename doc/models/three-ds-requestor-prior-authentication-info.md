...
| `threeDsReqPriorAuthMethod` | [`?string(ThreeDsReqPriorAuthMethod)`](../../doc/models/three-ds-req-prior-auth-method.md) | Optional | **Constraints**: *Maximum Length*: `12` | getThreeDsReqPriorAuthMethod(): ?string | setThreeDsReqPriorAuthMethod(?string threeDsReqPriorAuthMethod): void |
