...
| `ownershipType` | [`string(OwnershipType)`](../../doc/models/ownership-type.md) | Required | **Constraints**: *Maximum Length*: `10` | getOwnershipType(): string | setOwnershipType(string ownershipType): void |
...
| `preferredLanguage` | `?array` | Optional | - | getPreferredLanguage(): ?array | setPreferredLanguage(?array preferredLanguage): void |
