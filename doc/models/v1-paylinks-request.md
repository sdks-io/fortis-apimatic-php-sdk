...
| `amountDue` | `int` | Required | This is the amount that need to be paid (automatically calculated by system). amount_due= sum of items in item_list<br><br>**Constraints**: `>= 1`, `<= 999999999` | getAmountDue(): int | setAmountDue(int amountDue): void |
