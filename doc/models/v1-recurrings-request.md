...
| `interval` | `int` | Required | Interval<br><br>**Constraints**: `>= 0`, `<= 365` | getInterval(): int | setInterval(int interval): void |
| `intervalType` | [`string(IntervalType)`](../../doc/models/interval-type.md) | Required | - | getIntervalType(): string | setIntervalType(string intervalType): void |
...
| `startDate` | `string` | Required | Start date<br><br>**Constraints**: *Maximum Length*: `10`, *Pattern*: `^[\d]{4}-[\d]{2}-[\d]{2}$` | getStartDate(): string | setStartDate(string startDate): void |
