...
| `terminalApplicationId` | `string` | Required | Terminal Application ID<br><br>**Constraints**: *Pattern*: `^(([0-9a-fA-F\-]{24,36})\|(([0-9a-fA-F]{8})-(([0-9a-fA-F]{4}\-){3})([0-9a-fA-F]{12})))$` | getTerminalApplicationId(): string | setTerminalApplicationId(string terminalApplicationId): void |
...
| `terminalManufacturerCode` | [`string(TerminalManufacturerCode)`](../../doc/models/terminal-manufacturer-code.md) | Required | - | getTerminalManufacturerCode(): string | setTerminalManufacturerCode(string terminalManufacturerCode): void |
| `title` | `string` | Required | Terminal Name<br><br>**Constraints**: *Maximum Length*: `64` | getTitle(): string | setTitle(string title): void |
...
| `serialNumber` | `string` | Required | Terminal Serial Number<br><br>**Constraints**: *Maximum Length*: `24`, *Pattern*: `^[a-zA-Z0-9]*$` | getSerialNumber(): string | setSerialNumber(string serialNumber): void |
