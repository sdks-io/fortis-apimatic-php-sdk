...
| `ticket` | `string` | Required | A valid ticket that was created to store the token.<br><br>**Constraints**: *Minimum Length*: `1`, *Maximum Length*: `36` | getTicket(): string | setTicket(string ticket): void |
