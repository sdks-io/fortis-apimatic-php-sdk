...
| `identityVerification` | [`?IdentityVerification1`](../../doc/models/identity-verification-1.md) | Optional | - | getIdentityVerification(): ?IdentityVerification1 | setIdentityVerification(?IdentityVerification1 identityVerification): void |
...
| `walletType` | `?array` | Optional | - | getWalletType(): ?array | setWalletType(?array walletType): void |
...
| `initiationType` | `?array` | Optional | - | getInitiationType(): ?array | setInitiationType(?array initiationType): void |
...
| `trackData` | `string` | Required | Track Data from a magnetic card swipe.<br><br>**Constraints**: *Maximum Length*: `256` | getTrackData(): string | setTrackData(string trackData): void |
