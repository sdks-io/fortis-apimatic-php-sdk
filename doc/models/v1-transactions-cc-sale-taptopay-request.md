...
| `cardReaderId` | `?string` | Optional | Identifier of card reader used in Tap to Pay transactions. | getCardReaderId(): ?string | setCardReaderId(?string cardReaderId): void |
