...
| `contactId` | `?string` | Optional | Contact<br><br>**Constraints**: *Pattern*: `^(([0-9a-fA-F\-]{24,36})\|(([0-9a-fA-F]{8})-(([0-9a-fA-F]{4}\-){3})([0-9a-fA-F]{12})))$` | getContactId(): ?string | setContactId(?string contactId): void |
...
| `email` | `string` | Required | Email<br><br>**Constraints**: *Maximum Length*: `128` | getEmail(): string | setEmail(string email): void |
...
| `lastName` | `string` | Required | Last Name<br><br>**Constraints**: *Maximum Length*: `64` | getLastName(): string | setLastName(string lastName): void |
...
| `primaryLocationId` | `string` | Required | Primary Location ID<br><br>**Constraints**: *Pattern*: `^(([0-9a-fA-F\-]{24,36})\|(([0-9a-fA-F]{8})-(([0-9a-fA-F]{4}\-){3})([0-9a-fA-F]{12})))$` | getPrimaryLocationId(): string | setPrimaryLocationId(string primaryLocationId): void |
