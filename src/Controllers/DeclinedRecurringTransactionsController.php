...
class DeclinedRecurringTransactionsController extends BaseController
{
    ...
    public function getoneDeclinedRecurringTransaction(
        ...
        $_reqBuilder = $this->requestBuilder(
            ...
            ->parameters(
                TemplateParam::init('declined_recurring_transaction_id', $declinedRecurringTransactionId)->required(),
     ...
     * @return ApiResponse Response from the API call
     */
    public function createapayment(V1DeclinedRecurringTransactionPaymentsRequest $body): ApiResponse
    {
     ...
     * @return ApiResponse Response from the API call
     */
    public function rerunthetransaction(string $declinedRecurringTransactionId, ?array $expand = null): ApiResponse
    {
        $_reqBuilder = $this->requestBuilder(
            RequestMethod::POST,
     ...
     * @return ApiResponse Response from the API call
     */
    public function resendthetransaction(string $declinedRecurringTransactionId): ApiResponse
    {
        $_reqBuilder = $this->requestBuilder(
            RequestMethod::POST,
