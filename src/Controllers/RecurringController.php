...
class RecurringController extends BaseController
{
     ...
     */
    public function createanewrecurringrecord(V1RecurringsRequest $body, ?array $expand = null): ApiResponse
    {
     ...
     * @return ApiResponse Response from the API call
     */
    public function deleterecurringrecord(string $recurringId): ApiResponse
    {
        $_reqBuilder = $this->requestBuilder(RequestMethod::DELETE, '/v1/recurrings/{recurring_id}')
            ->auth(Auth::and('user-id', 'user-api-key', 'developer-id'))
            ->parameters(TemplateParam::init('recurring_id', $recurringId)->required());
    ...
    public function viewsinglerecurringrecord(
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/v1/recurrings/{recurring_id}')
            ->auth(Auth::and('user-id', 'user-api-key', 'developer-id'))
            ->parameters(
                TemplateParam::init('recurring_id', $recurringId)->required(),
                QueryParam::init('expand', $expand),
                QueryParam::init('fields', $fields)
            );
     ...
     * @return ApiResponse Response from the API call
     */
    public function activaterecurringpayment(string $recurringId, ?array $expand = null): ApiResponse
    {
     ...
     * @return ApiResponse Response from the API call
     */
    public function placeonholdrecurringpayment(string $recurringId, ?array $expand = null): ApiResponse
    {
