...
class TagsController extends BaseController
{
     ...
     */
    public function createanewtag(V1TagsRequest $body, ?array $expand = null): ApiResponse
    {
     ...
     * @return ApiResponse Response from the API call
     */
    public function deletetagrecord(string $tagId): ApiResponse
    {
        $_reqBuilder = $this->requestBuilder(RequestMethod::DELETE, '/v1/tags/{tag_id}')
            ->auth(Auth::and('user-id', 'user-api-key', 'developer-id'))
            ->parameters(TemplateParam::init('tag_id', $tagId)->required());
     ...
     * @return ApiResponse Response from the API call
     */
    public function viewsingletagsrecord(string $tagId, ?array $expand = null, ?array $fields = null): ApiResponse
    {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/v1/tags/{tag_id}')
            ->auth(Auth::and('user-id', 'user-api-key', 'developer-id'))
            ->parameters(
                TemplateParam::init('tag_id', $tagId)->required(),
                QueryParam::init('expand', $expand),
                QueryParam::init('fields', $fields)
            );
     ...
     * @return ApiResponse Response from the API call
     */
    public function updatetagrecord(string $tagId, V1TagsRequest1 $body): ApiResponse
    {
