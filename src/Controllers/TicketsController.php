...
class TicketsController extends BaseController
{
     ...
     */
    public function createaTicketrecord(V1TicketsRequest $body, ?array $expand = null): ApiResponse
    {
     ...
     * @return ApiResponse Response from the API call
     */
    public function viewsingleticketrecord(string $ticketId, ?array $expand = null, ?array $fields = null): ApiResponse
    {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/v1/tickets/{ticket_id}')
            ->auth(Auth::and('user-id', 'user-api-key', 'developer-id'))
            ->parameters(
                TemplateParam::init('ticket_id', $ticketId)->required(),
                QueryParam::init('expand', $expand),
                QueryParam::init('fields', $fields)
            );
