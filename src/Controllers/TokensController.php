...
class TokensController extends BaseController
{
     ...
     */
    public function createanewAchToken(V1TokensAchRequest $body, ?array $expand = null): ApiResponse
    {
     ...
     * @return ApiResponse Response from the API call
     */
    public function createanewCreditCardToken(V1TokensCcRequest $body, ?array $expand = null): ApiResponse
    {
     ...
     * @return ApiResponse Response from the API call
     */
    public function createanewTerminalTokenwithAsyncmethod(V1TokensTerminalAsyncRequest $body): ApiResponse
    {
     ...
     * @return ApiResponse Response from the API call
     */
    public function createanewTerminalToken(V1TokensTerminalRequest $body, ?array $expand = null): ApiResponse
    {
     ...
     * @return ApiResponse Response from the API call
     */
    public function createanewTicketToken(V1TokensTicketRequest $body, ?array $expand = null): ApiResponse
    {
     ...
     * @return ApiResponse Response from the API call
     */
    public function createanewWalletToken(V1TokensWalletRequest $body, ?array $expand = null): ApiResponse
    {
     ...
     * @return ApiResponse Response from the API call
     */
    public function deleteasingletokenrecord(string $tokenId): ApiResponse
    {
        $_reqBuilder = $this->requestBuilder(RequestMethod::DELETE, '/v1/tokens/{token_id}')
            ->auth(Auth::and('user-id', 'user-api-key', 'developer-id'))
            ->parameters(TemplateParam::init('token_id', $tokenId)->required());
     ...
     * @return ApiResponse Response from the API call
     */
    public function viewsingletokenrecord(string $tokenId, ?array $expand = null, ?array $fields = null): ApiResponse
    {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/v1/tokens/{token_id}')
            ->auth(Auth::and('user-id', 'user-api-key', 'developer-id'))
            ->parameters(
                TemplateParam::init('token_id', $tokenId)->required(),
                QueryParam::init('expand', $expand),
     ...
     * @return ApiResponse Response from the API call
     */
    public function updateAchToken(string $tokenId, V1TokensAchRequest1 $body, ?array $expand = null): ApiResponse
    {
     ...
     * @return ApiResponse Response from the API call
     */
    public function updateCcToken(string $tokenId, V1TokensCcRequest1 $body, ?array $expand = null): ApiResponse
    {
