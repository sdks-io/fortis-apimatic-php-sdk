...
class UserVerificationsController extends BaseController
{
     ...
     */
    public function getuserverification(string $userVerificationId): ApiResponse
    {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/v1/user-verifications/{user_verification_id}')
            ...
            ->parameters(TemplateParam::init('user_verification_id', $userVerificationId)->required());
