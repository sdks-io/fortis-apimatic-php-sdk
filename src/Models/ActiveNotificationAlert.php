...
class ActiveNotificationAlert implements \JsonSerializable
{
     ...
     * Returns Alert Type.
     */
    public function getAlertType(): ?array
    {
     ...
     * @maps alert_type
     */
    public function setAlertType(?array $alertType): void
    {
     ...
     */
    public function getAlertTypeId(): ?array
    {
     ...
     * @maps alert_type_id
     */
    public function setAlertTypeId(?array $alertTypeId): void
    {
    ...
    public function jsonSerialize(bool $asArrayWhenEmpty = false)
    {
        ...
        if (isset($this->alertType)) {
            $json['alert_type']       = $this->alertType;
        }
        if (isset($this->alertTypeId)) {
            $json['alert_type_id']    = $this->alertTypeId;
        }
