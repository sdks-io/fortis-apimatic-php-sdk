...
class Addon implements \JsonSerializable
{
    ...
    /**
     * Converts the Addon object to a human-readable string representation.
     *
     * @return string The string representation of the Addon object.
     */
    public function __toString(): string
    {
        return ApiHelper::stringify(
            ...
            [
                ...
                'locationSetupUrl' => $this->getLocationSetupUrl(),
                'userSetupUrl' => $this->getUserSetupUrl(),
                'encryptUrlParams' => $this->encryptUrlParams,
