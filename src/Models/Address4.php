...
class Address4 implements \JsonSerializable
{
    /**
     * @var array
     */
    ...
    /**
     * Converts the Address4 object to a human-readable string representation.
     *
     * @return string The string representation of the Address4 object.
     */
    ...
    protected $propertyNames = ['city', 'state', 'postal_code', 'country', 'street'];
