...
class AltBankAccount2 implements \JsonSerializable
{
    /**
     * @var array
     */
     ...
     * @maps deposit_type
     */
    public function setDepositType(?string $depositType): void
    {
     ...
     * Deposit type.
     */
    public function unsetDepositType(): void
    {
        $this->depositType = [];
    }

    /**
     * Converts the AltBankAccount2 object to a human-readable string representation.
     *
     * @return string The string representation of the AltBankAccount2 object.
     */
    ...
    protected $propertyNames = ['routing_number', 'account_number', 'account_holder_name', 'deposit_type'];
    ...
    public function jsonSerialize(bool $asArrayWhenEmpty = false)
    {
        ...
        if (!empty($this->depositType)) {
            $json['deposit_type']        = $this->depositType['value'];
        }
