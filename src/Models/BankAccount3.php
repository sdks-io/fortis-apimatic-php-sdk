...
class BankAccount3 implements \JsonSerializable
{
    /**
     * @var array
     */
    ...
    /**
     * Converts the BankAccount3 object to a human-readable string representation.
     *
     * @return string The string representation of the BankAccount3 object.
     */
    ...
    protected $propertyNames = ['routing_number', 'account_number', 'account_holder_name'];
