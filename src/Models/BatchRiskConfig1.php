...
class BatchRiskConfig1 implements \JsonSerializable
{
    /**
     * @var array
     */
    ...
    /**
     * Converts the BatchRiskConfig1 object to a human-readable string representation.
     *
     * @return string The string representation of the BatchRiskConfig1 object.
     */
    ...
    protected $propertyNames = ['blind_refund_total_count', 'blind_refund_max_amount'];
