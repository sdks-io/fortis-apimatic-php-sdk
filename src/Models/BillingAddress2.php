...
class BillingAddress2 implements \JsonSerializable
{
    /**
     * @var array
     */
    ...
    /**
     * Returns Phone.
     * The Phone # to be used to contact Payer if there are any issues processing a transaction. Country
     * code not included
     */
    ...
    /**
     * Converts the BillingAddress2 object to a human-readable string representation.
     *
     * @return string The string representation of the BillingAddress2 object.
     */
    ...
    protected $propertyNames = ['city', 'state', 'postal_code', 'street', 'phone', 'country'];
