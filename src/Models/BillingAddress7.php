...
class BillingAddress7 implements \JsonSerializable
{
    /**
     * @var array
     */
    ...
    /**
     * Converts the BillingAddress7 object to a human-readable string representation.
     *
     * @return string The string representation of the BillingAddress7 object.
     */
    ...
    protected $propertyNames = ['postal_code', 'street', 'city', 'state', 'phone', 'country'];
