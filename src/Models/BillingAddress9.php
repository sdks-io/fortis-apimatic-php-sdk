...
class BillingAddress9 implements \JsonSerializable
{
    /**
     * @var array
     */
    ...
    /**
     * Converts the BillingAddress9 object to a human-readable string representation.
     *
     * @return string The string representation of the BillingAddress9 object.
     */
    ...
    protected $propertyNames = ['postal_code', 'street'];
