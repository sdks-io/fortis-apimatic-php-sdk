 ...
 */
class BrandingDomain1 implements \JsonSerializable
{
    /**
     * @var string|null
     */
     ...
     */
    public function getContactUserDefaultEntryPage(): ?array
    {
     ...
     */
    public function setContactUserDefaultEntryPage(?array $contactUserDefaultEntryPage): void
    {
    ...
    /**
     * Converts the BrandingDomain1 object to a human-readable string representation.
     *
     * @return string The string representation of the BrandingDomain1 object.
     */
    public function __toString(): string
    {
        return ApiHelper::stringify(
            ...
            [
                ...
                'contactUserDefaultEntryPage' => $this->contactUserDefaultEntryPage,
    ...
    public function jsonSerialize(bool $asArrayWhenEmpty = false)
    {
        ...
        if (isset($this->registrationFields)) {
            $json['registration_fields']             = $this->registrationFields;
        }
        ...
        if (isset($this->contactUserDefaultEntryPage)) {
            $json['contact_user_default_entry_page'] = $this->contactUserDefaultEntryPage;
        }
