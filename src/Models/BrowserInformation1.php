...
class BrowserInformation1 implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the BrowserInformation1 object to a human-readable string representation.
     *
     * @return string The string representation of the BrowserInformation1 object.
     */
    ...
    public function jsonSerialize(bool $asArrayWhenEmpty = false)
    {
        ...
        if (isset($this->challengeWindowSize)) {
            $json['challenge_window_size']      = $this->challengeWindowSize;
        }
