...
/**
 * Builder for model AccountVault1
 *
 * @see AccountVault1
 */
class AccountVault1Builder
{
    /**
     * @var AccountVault1
     */
    ...
    private function __construct(AccountVault1 $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Account Vault 1 Builder object.
     */
    public static function init(): self
    {
        return new self(new AccountVault1());
    }
    ...
    /**
     * Initializes a new Account Vault 1 object.
     */
    public function build(): AccountVault1
    {
