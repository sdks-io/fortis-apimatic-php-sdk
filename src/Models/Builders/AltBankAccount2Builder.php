...
/**
 * Builder for model AltBankAccount2
 *
 * @see AltBankAccount2
 */
class AltBankAccount2Builder
{
    /**
     * @var AltBankAccount2
     */
    ...
    private function __construct(AltBankAccount2 $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Alt Bank Account 2 Builder object.
     */
    public static function init(): self
    {
        return new self(new AltBankAccount2());
    }
    ...
    /**
     * Initializes a new Alt Bank Account 2 object.
     */
    public function build(): AltBankAccount2
    {
