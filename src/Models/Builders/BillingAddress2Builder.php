...
/**
 * Builder for model BillingAddress2
 *
 * @see BillingAddress2
 */
class BillingAddress2Builder
{
    /**
     * @var BillingAddress2
     */
    ...
    private function __construct(BillingAddress2 $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Billing Address 2 Builder object.
     */
    public static function init(): self
    {
        return new self(new BillingAddress2());
    }
    ...
    /**
     * Initializes a new Billing Address 2 object.
     */
    public function build(): BillingAddress2
    {
