...
/**
 * Builder for model BrandingDomain1
 *
 * @see BrandingDomain1
 */
class BrandingDomain1Builder
{
    /**
     * @var BrandingDomain1
     */
    ...
    private function __construct(BrandingDomain1 $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Branding Domain 1 Builder object.
     */
    public static function init(): self
    {
        return new self(new BrandingDomain1());
    }
    ...
    /**
     * Initializes a new Branding Domain 1 object.
     */
    public function build(): BrandingDomain1
    {
