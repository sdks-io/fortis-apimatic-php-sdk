...
/**
 * Builder for model BrandingDomain2
 *
 * @see BrandingDomain2
 */
class BrandingDomain2Builder
{
    /**
     * @var BrandingDomain2
     */
    ...
    private function __construct(BrandingDomain2 $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Branding Domain 2 Builder object.
     */
    public static function init(): self
    {
        return new self(new BrandingDomain2());
    }
     ...
     */
    public function contactUserDefaultEntryPage(?array $value): self
    {
    ...
    /**
     * Initializes a new Branding Domain 2 object.
     */
    public function build(): BrandingDomain2
    {
