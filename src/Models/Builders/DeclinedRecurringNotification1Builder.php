...
/**
 * Builder for model DeclinedRecurringNotification1
 *
 * @see DeclinedRecurringNotification1
 */
class DeclinedRecurringNotification1Builder
{
    /**
     * @var DeclinedRecurringNotification1
     */
    private $instance;

    private function __construct(DeclinedRecurringNotification1 $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Declined Recurring Notification 1 Builder object.
     */
    public static function init(): self
    {
        return new self(new DeclinedRecurringNotification1());
    }
    ...
    /**
     * Initializes a new Declined Recurring Notification 1 object.
     */
    public function build(): DeclinedRecurringNotification1
    {
