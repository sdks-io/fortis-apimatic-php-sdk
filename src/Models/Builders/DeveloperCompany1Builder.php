...
/**
 * Builder for model DeveloperCompany1
 *
 * @see DeveloperCompany1
 */
class DeveloperCompany1Builder
{
    /**
     * @var DeveloperCompany1
     */
    private $instance;

    private function __construct(DeveloperCompany1 $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Developer Company 1 Builder object.
     */
    public static function init(): self
    {
        return new self(new DeveloperCompany1());
    }
    ...
    /**
     * Initializes a new Developer Company 1 object.
     */
    public function build(): DeveloperCompany1
    {
