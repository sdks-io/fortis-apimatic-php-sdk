...
/**
 * Builder for model Domain1
 *
 * @see Domain1
 */
class Domain1Builder
{
    /**
     * @var Domain1
     */
    ...
    private function __construct(Domain1 $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Domain 1 Builder object.
     */
    public static function init(): self
    {
        return new self(new Domain1());
    }
    ...
    /**
     * Initializes a new Domain 1 object.
     */
    public function build(): Domain1
    {
