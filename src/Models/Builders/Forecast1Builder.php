...
/**
 * Builder for model Forecast1
 *
 * @see Forecast1
 */
class Forecast1Builder
{
    /**
     * @var Forecast1
     */
    ...
    private function __construct(Forecast1 $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Forecast 1 Builder object.
     */
    public static function init(): self
    {
        return new self(new Forecast1());
    }
    ...
    /**
     * Initializes a new Forecast 1 object.
     */
    public function build(): Forecast1
    {
