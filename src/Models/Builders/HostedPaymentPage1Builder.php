...
/**
 * Builder for model HostedPaymentPage1
 *
 * @see HostedPaymentPage1
 */
class HostedPaymentPage1Builder
{
    /**
     * @var HostedPaymentPage1
     */
    private $instance;

    private function __construct(HostedPaymentPage1 $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Hosted Payment Page 1 Builder object.
     */
    public static function init(): self
    {
        return new self(new HostedPaymentPage1());
    }
     ...
     *
     * @param FieldConfiguration2|null $value
     */
    public function fieldConfiguration(?FieldConfiguration2 $value): self
    {
    ...
    /**
     * Initializes a new Hosted Payment Page 1 object.
     */
    public function build(): HostedPaymentPage1
    {
