...
use FortisApiLib\Models\Level3Data3;
use FortisApiLib\Models\LineItem19;

/**
 * Builder for model Level3Data3
 *
 * @see Level3Data3
 */
class Level3Data3Builder
{
    /**
     * @var Level3Data3
     */
    ...
    private function __construct(Level3Data3 $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Level 3 Data 3 Builder object.
     *
     * @param LineItem19[] $lineItems
     */
    public static function init(array $lineItems): self
    {
        return new self(new Level3Data3($lineItems));
    }
    ...
    /**
     * Initializes a new Level 3 Data 3 object.
     */
    public function build(): Level3Data3
    {
