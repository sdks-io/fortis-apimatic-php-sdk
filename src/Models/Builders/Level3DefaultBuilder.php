...
/**
 * Builder for model Level3Default
 *
 * @see Level3Default
 */
class Level3DefaultBuilder
{
    /**
     * @var Level3Default
     */
    ...
    private function __construct(Level3Default $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Level 3 Default Builder object.
     */
    public static function init(): self
    {
        return new self(new Level3Default());
    }
    ...
    /**
     * Initializes a new Level 3 Default object.
     */
    public function build(): Level3Default
    {
