...
use FortisApiLib\Models\LogSms1;
use FortisApiLib\Models\ProductTransaction1;
use FortisApiLib\Models\QuickInvoiceSetting1;
use FortisApiLib\Models\QuickInvoiceView;
use FortisApiLib\Models\SmsBlacklist1;
...
class List10Builder
{
     ...
     *
     * @param QuickInvoiceSetting1|null $value
     */
    public function quickInvoiceSetting(?QuickInvoiceSetting1 $value): self
    {
     ...
     * @param User9|null $value
     */
    public function modifiedUser(?User9 $value): self
    {
     ...
     * Sets log sms field.
     *
     * @param LogSms1|null $value
     */
    public function logSms(?LogSms1 $value): self
    {
     ...
     */
    public function ccProductTransaction(?ProductTransaction1 $value): self
    {
     ...
     * @param ProductTransaction1|null $value
     */
    public function achProductTransaction(?ProductTransaction1 $value): self
    {
     ...
     *
     * @param SmsBlacklist1|null $value
     */
    public function smsBlacklist(?SmsBlacklist1 $value): self
    {
