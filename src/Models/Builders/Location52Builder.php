...
/**
 * Builder for model Location52
 *
 * @see Location52
 */
class Location52Builder
{
    /**
     * @var Location52
     */
    ...
    private function __construct(Location52 $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Location 52 Builder object.
     */
    public static function init(): self
    {
        return new self(new Location52());
    }
    ...
    /**
     * Initializes a new Location 52 object.
     */
    public function build(): Location52
    {
