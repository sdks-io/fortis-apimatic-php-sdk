...
/**
 * Builder for model LogSms1
 *
 * @see LogSms1
 */
class LogSms1Builder
{
    /**
     * @var LogSms1
     */
    ...
    private function __construct(LogSms1 $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Log Sms 1 Builder object.
     */
    public static function init(): self
    {
        return new self(new LogSms1());
    }
    ...
    /**
     * Initializes a new Log Sms 1 object.
     */
    public function build(): LogSms1
    {
