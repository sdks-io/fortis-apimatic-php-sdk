...
/**
 * Builder for model Parent5
 *
 * @see Parent5
 */
class Parent5Builder
{
    /**
     * @var Parent5
     */
    ...
    private function __construct(Parent5 $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Parent 5 Builder object.
     */
    public static function init(): self
    {
        return new self(new Parent5());
    }
    ...
    /**
     * Initializes a new Parent 5 object.
     */
    public function build(): Parent5
    {
