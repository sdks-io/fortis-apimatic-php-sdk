...
/**
 * Builder for model PaymentRecurringNotification1
 *
 * @see PaymentRecurringNotification1
 */
class PaymentRecurringNotification1Builder
{
    /**
     * @var PaymentRecurringNotification1
     */
    private $instance;

    private function __construct(PaymentRecurringNotification1 $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Payment Recurring Notification 1 Builder object.
     */
    public static function init(): self
    {
        return new self(new PaymentRecurringNotification1());
    }
    ...
    /**
     * Initializes a new Payment Recurring Notification 1 object.
     */
    public function build(): PaymentRecurringNotification1
    {
