...
/**
 * Builder for model PaymentRecurringNotification
 *
 * @see PaymentRecurringNotification
 */
class PaymentRecurringNotificationBuilder
{
    /**
     * @var PaymentRecurringNotification
     */
    private $instance;

    private function __construct(PaymentRecurringNotification $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Payment Recurring Notification Builder object.
     */
    public static function init(): self
    {
        return new self(new PaymentRecurringNotification());
    }
    ...
    /**
     * Initializes a new Payment Recurring Notification object.
     */
    public function build(): PaymentRecurringNotification
    {
