...
/**
 * Builder for model PrimaryPrincipal2
 *
 * @see PrimaryPrincipal2
 */
class PrimaryPrincipal2Builder
{
    /**
    ...
    private function __construct(PrimaryPrincipal2 $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Primary Principal 2 Builder object.
     *
    ...
    {
        return new self(new PrimaryPrincipal2($firstName, $lastName));
    }
    ...
    /**
     * Initializes a new Primary Principal 2 object.
     */
    public function build(): PrimaryPrincipal2
    {
