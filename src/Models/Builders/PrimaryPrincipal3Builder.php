...
/**
 * Builder for model PrimaryPrincipal3
 *
 * @see PrimaryPrincipal3
 */
class PrimaryPrincipal3Builder
{
    /**
     * @var PrimaryPrincipal3
     */
    private $instance;

    private function __construct(PrimaryPrincipal3 $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Primary Principal 3 Builder object.
     */
    public static function init(): self
    {
        return new self(new PrimaryPrincipal3());
    }
    ...
    /**
     * Initializes a new Primary Principal 3 object.
     */
    public function build(): PrimaryPrincipal3
    {
