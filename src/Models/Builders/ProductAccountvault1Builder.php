...
/**
 * Builder for model ProductAccountvault1
 *
 * @see ProductAccountvault1
 */
class ProductAccountvault1Builder
{
    /**
     * @var ProductAccountvault1
     */
    private $instance;

    private function __construct(ProductAccountvault1 $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Product Accountvault 1 Builder object.
     */
    public static function init(): self
    {
        return new self(new ProductAccountvault1());
    }
    ...
    /**
     * Initializes a new Product Accountvault 1 object.
     */
    public function build(): ProductAccountvault1
    {
