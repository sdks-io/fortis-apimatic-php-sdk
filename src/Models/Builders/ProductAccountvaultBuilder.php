...
/**
 * Builder for model ProductAccountvault
 *
 * @see ProductAccountvault
 */
class ProductAccountvaultBuilder
{
    /**
     * @var ProductAccountvault
     */
    private $instance;

    private function __construct(ProductAccountvault $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Product Accountvault Builder object.
     */
    public static function init(): self
    {
        return new self(new ProductAccountvault());
    }
    ...
    /**
     * Initializes a new Product Accountvault object.
     */
    public function build(): ProductAccountvault
    {
