...
/**
 * Builder for model ProductFile1
 *
 * @see ProductFile1
 */
class ProductFile1Builder
{
    /**
     * @var ProductFile1
     */
    ...
    private function __construct(ProductFile1 $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Product File 1 Builder object.
     */
    public static function init(): self
    {
        return new self(new ProductFile1());
    }
    ...
    /**
     * Initializes a new Product File 1 object.
     */
    public function build(): ProductFile1
    {
