...
/**
 * Builder for model ProductRecurring1
 *
 * @see ProductRecurring1
 */
class ProductRecurring1Builder
{
    /**
     * @var ProductRecurring1
     */
    private $instance;

    private function __construct(ProductRecurring1 $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Product Recurring 1 Builder object.
     */
    public static function init(): self
    {
        return new self(new ProductRecurring1());
    }
    ...
    /**
     * Initializes a new Product Recurring 1 object.
     */
    public function build(): ProductRecurring1
    {
