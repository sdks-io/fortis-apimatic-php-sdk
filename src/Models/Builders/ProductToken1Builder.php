...
/**
 * Builder for model ProductToken1
 *
 * @see ProductToken1
 */
class ProductToken1Builder
{
    /**
     * @var ProductToken1
     */
    ...
    private function __construct(ProductToken1 $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Product Token 1 Builder object.
     */
    public static function init(): self
    {
        return new self(new ProductToken1());
    }
    ...
    /**
     * Initializes a new Product Token 1 object.
     */
    public function build(): ProductToken1
    {
