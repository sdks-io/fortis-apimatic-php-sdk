...
use FortisApiLib\Models\MerchantRiskIndicator1;
use FortisApiLib\Models\Purchase1;

/**
 * Builder for model Purchase1
 *
 * @see Purchase1
 */
class Purchase1Builder
{
    /**
     * @var Purchase1
     */
    ...
    private function __construct(Purchase1 $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Purchase 1 Builder object.
     */
    public static function init(): self
    {
        return new self(new Purchase1());
    }
    ...
    /**
     * Initializes a new Purchase 1 object.
     */
    public function build(): Purchase1
    {
