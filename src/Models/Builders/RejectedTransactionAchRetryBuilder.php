...
/**
 * Builder for model RejectedTransactionAchRetry
 *
 * @see RejectedTransactionAchRetry
 */
class RejectedTransactionAchRetryBuilder
{
    /**
     * @var RejectedTransactionAchRetry
     */
    private $instance;

    private function __construct(RejectedTransactionAchRetry $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Rejected Transaction Ach Retry Builder object.
     */
    public static function init(): self
    {
        return new self(new RejectedTransactionAchRetry());
    }
    ...
    /**
     * Initializes a new Rejected Transaction Ach Retry object.
     */
    public function build(): RejectedTransactionAchRetry
    {
