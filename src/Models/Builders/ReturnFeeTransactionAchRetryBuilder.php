...
/**
 * Builder for model ReturnFeeTransactionAchRetry
 *
 * @see ReturnFeeTransactionAchRetry
 */
class ReturnFeeTransactionAchRetryBuilder
{
    /**
     * @var ReturnFeeTransactionAchRetry
     */
    private $instance;

    private function __construct(ReturnFeeTransactionAchRetry $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Return Fee Transaction Ach Retry Builder object.
     */
    public static function init(): self
    {
        return new self(new ReturnFeeTransactionAchRetry());
    }
    ...
    /**
     * Initializes a new Return Fee Transaction Ach Retry object.
     */
    public function build(): ReturnFeeTransactionAchRetry
    {
