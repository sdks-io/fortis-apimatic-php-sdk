...
/**
 * Builder for model SavedAccount1
 *
 * @see SavedAccount1
 */
class SavedAccount1Builder
{
    /**
     * @var SavedAccount1
     */
    ...
    private function __construct(SavedAccount1 $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Saved Account 1 Builder object.
     */
    public static function init(): self
    {
        return new self(new SavedAccount1());
    }
    ...
    /**
     * Initializes a new Saved Account 1 object.
     */
    public function build(): SavedAccount1
    {
