...
/**
 * Builder for model SavedAccount
 *
 * @see SavedAccount
 */
class SavedAccountBuilder
{
    /**
     * @var SavedAccount
     */
    ...
    private function __construct(SavedAccount $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Saved Account Builder object.
     */
    public static function init(): self
    {
        return new self(new SavedAccount());
    }
    ...
    /**
     * Initializes a new Saved Account object.
     */
    public function build(): SavedAccount
    {
