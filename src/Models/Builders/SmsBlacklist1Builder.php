...
/**
 * Builder for model SmsBlacklist1
 *
 * @see SmsBlacklist1
 */
class SmsBlacklist1Builder
{
    /**
     * @var SmsBlacklist1
     */
    ...
    private function __construct(SmsBlacklist1 $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Sms Blacklist 1 Builder object.
     */
    public static function init(): self
    {
        return new self(new SmsBlacklist1());
    }
    ...
    /**
     * Initializes a new Sms Blacklist 1 object.
     */
    public function build(): SmsBlacklist1
    {
