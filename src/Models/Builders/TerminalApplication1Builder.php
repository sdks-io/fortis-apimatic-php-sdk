...
/**
 * Builder for model TerminalApplication1
 *
 * @see TerminalApplication1
 */
class TerminalApplication1Builder
{
    /**
     * @var TerminalApplication1
     */
    private $instance;

    private function __construct(TerminalApplication1 $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Terminal Application 1 Builder object.
     */
    public static function init(): self
    {
        return new self(new TerminalApplication1());
    }
    ...
    /**
     * Initializes a new Terminal Application 1 object.
     */
    public function build(): TerminalApplication1
    {
