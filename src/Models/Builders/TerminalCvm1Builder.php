...
/**
 * Builder for model TerminalCvm1
 *
 * @see TerminalCvm1
 */
class TerminalCvm1Builder
{
    /**
     * @var TerminalCvm1
     */
    ...
    private function __construct(TerminalCvm1 $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Terminal Cvm 1 Builder object.
     */
    public static function init(): self
    {
        return new self(new TerminalCvm1());
    }
    ...
    /**
     * Initializes a new Terminal Cvm 1 object.
     */
    public function build(): TerminalCvm1
    {
