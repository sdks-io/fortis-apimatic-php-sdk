...
/**
 * Builder for model TerminalManufacturer1
 *
 * @see TerminalManufacturer1
 */
class TerminalManufacturer1Builder
{
    /**
     * @var TerminalManufacturer1
     */
    private $instance;

    private function __construct(TerminalManufacturer1 $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Terminal Manufacturer 1 Builder object.
     */
    public static function init(): self
    {
        return new self(new TerminalManufacturer1());
    }
    ...
    /**
     * Initializes a new Terminal Manufacturer 1 object.
     */
    public function build(): TerminalManufacturer1
    {
