...
/**
 * Builder for model TerminalTimeouts1
 *
 * @see TerminalTimeouts1
 */
class TerminalTimeouts1Builder
{
    /**
     * @var TerminalTimeouts1
     */
    private $instance;

    private function __construct(TerminalTimeouts1 $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Terminal Timeouts 1 Builder object.
     */
    public static function init(): self
    {
        return new self(new TerminalTimeouts1());
    }
    ...
    /**
     * Initializes a new Terminal Timeouts 1 object.
     */
    public function build(): TerminalTimeouts1
    {
