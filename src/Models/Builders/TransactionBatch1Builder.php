...
/**
 * Builder for model TransactionBatch1
 *
 * @see TransactionBatch1
 */
class TransactionBatch1Builder
{
    /**
     * @var TransactionBatch1
     */
    private $instance;

    private function __construct(TransactionBatch1 $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Transaction Batch 1 Builder object.
     */
    public static function init(): self
    {
        return new self(new TransactionBatch1());
    }
    ...
    /**
     * Initializes a new Transaction Batch 1 object.
     */
    public function build(): TransactionBatch1
    {
