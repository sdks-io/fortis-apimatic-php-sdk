...
/**
 * Builder for model V1TerminalsRequest
 *
 * @see V1TerminalsRequest
 */
class V1TerminalsRequestBuilder
{
    /**
     * @var V1TerminalsRequest
     */
    private $instance;

    private function __construct(V1TerminalsRequest $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new V1 Terminals Request Builder object.
     *
    ...
    public static function init(
        ...
        return new self(new V1TerminalsRequest(
            $locationId,
    ...
    /**
     * Initializes a new V1 Terminals Request object.
     */
    public function build(): V1TerminalsRequest
    {
