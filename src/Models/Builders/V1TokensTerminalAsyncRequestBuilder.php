...
/**
 * Builder for model V1TokensTerminalAsyncRequest
 *
 * @see V1TokensTerminalAsyncRequest
 */
class V1TokensTerminalAsyncRequestBuilder
{
    /**
     * @var V1TokensTerminalAsyncRequest
     */
    private $instance;

    private function __construct(V1TokensTerminalAsyncRequest $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new V1 Tokens Terminal Async Request Builder object.
     *
    ...
    {
        return new self(new V1TokensTerminalAsyncRequest($locationId, $terminalId));
    }
     ...
     *
     * @param BillingAddress7|null $value
     */
    public function billingAddress(?BillingAddress7 $value): self
    {
     ...
     *
     * @param IdentityVerification5|null $value
     */
    public function identityVerification(?IdentityVerification5 $value): self
    {
    ...
    /**
     * Initializes a new V1 Tokens Terminal Async Request object.
     */
    public function build(): V1TokensTerminalAsyncRequest
    {
