...
/**
 * Builder for model V1TransactionsCcAuthOnlySwipedRequest
 *
 * @see V1TransactionsCcAuthOnlySwipedRequest
 */
class V1TransactionsCcAuthOnlySwipedRequestBuilder
{
    /**
     * @var V1TransactionsCcAuthOnlySwipedRequest
     */
    private $instance;

    private function __construct(V1TransactionsCcAuthOnlySwipedRequest $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new V1 Transactions Cc Auth Only Swiped Request Builder object.
     *
     * @param int $transactionAmount
     * @param string $trackData
     */
    public static function init(int $transactionAmount, string $trackData): self
    {
        return new self(new V1TransactionsCcAuthOnlySwipedRequest($transactionAmount, $trackData));
    }
    ...
    /**
     * Initializes a new V1 Transactions Cc Auth Only Swiped Request object.
     */
    public function build(): V1TransactionsCcAuthOnlySwipedRequest
    {
