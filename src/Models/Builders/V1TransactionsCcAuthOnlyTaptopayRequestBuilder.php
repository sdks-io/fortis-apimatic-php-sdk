...
class V1TransactionsCcAuthOnlyTaptopayRequestBuilder
{
     ...
     */
    public static function init(string $cardDataCryptogram, string $generalCardData): self
    {
        return new self(new V1TransactionsCcAuthOnlyTaptopayRequest($cardDataCryptogram, $generalCardData));
    }
    ...
    /**
     * Sets card reader id field.
     *
     * @param string|null $value
     */
    public function cardReaderId(?string $value): self
    {
        $this->instance->setCardReaderId($value);
        return $this;
    }

    /**
     * Unsets card reader id field.
     */
    public function unsetCardReaderId(): self
    {
        $this->instance->unsetCardReaderId();
        return $this;
    }
