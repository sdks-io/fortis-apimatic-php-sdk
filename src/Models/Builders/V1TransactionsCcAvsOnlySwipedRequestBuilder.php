...
/**
 * Builder for model V1TransactionsCcAvsOnlySwipedRequest
 *
 * @see V1TransactionsCcAvsOnlySwipedRequest
 */
class V1TransactionsCcAvsOnlySwipedRequestBuilder
{
    /**
     * @var V1TransactionsCcAvsOnlySwipedRequest
     */
    private $instance;

    private function __construct(V1TransactionsCcAvsOnlySwipedRequest $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new V1 Transactions Cc Avs Only Swiped Request Builder object.
     *
     * @param string $trackData
     */
    public static function init(string $trackData): self
    {
        return new self(new V1TransactionsCcAvsOnlySwipedRequest($trackData));
    }
    ...
    /**
     * Initializes a new V1 Transactions Cc Avs Only Swiped Request object.
     */
    public function build(): V1TransactionsCcAvsOnlySwipedRequest
    {
