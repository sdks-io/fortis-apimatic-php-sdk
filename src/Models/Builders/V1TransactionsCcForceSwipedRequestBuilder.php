...
/**
 * Builder for model V1TransactionsCcForceSwipedRequest
 *
 * @see V1TransactionsCcForceSwipedRequest
 */
class V1TransactionsCcForceSwipedRequestBuilder
{
    /**
     * @var V1TransactionsCcForceSwipedRequest
     */
    private $instance;

    private function __construct(V1TransactionsCcForceSwipedRequest $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new V1 Transactions Cc Force Swiped Request Builder object.
     *
     * @param string $trackData
     * @param string $authCode
     */
    public static function init(string $trackData, string $authCode): self
    {
        return new self(new V1TransactionsCcForceSwipedRequest($trackData, $authCode));
    }
    ...
    /**
     * Initializes a new V1 Transactions Cc Force Swiped Request object.
     */
    public function build(): V1TransactionsCcForceSwipedRequest
    {
