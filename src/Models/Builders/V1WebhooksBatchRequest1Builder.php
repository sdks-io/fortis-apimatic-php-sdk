...
/**
 * Builder for model V1WebhooksBatchRequest1
 *
 * @see V1WebhooksBatchRequest1
 */
class V1WebhooksBatchRequest1Builder
{
    /**
     * @var V1WebhooksBatchRequest1
     */
    private $instance;

    private function __construct(V1WebhooksBatchRequest1 $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new V1 Webhooks Batch Request 1 Builder object.
     */
    public static function init(): self
    {
        return new self(new V1WebhooksBatchRequest1());
    }
    ...
    /**
     * Initializes a new V1 Webhooks Batch Request 1 object.
     */
    public function build(): V1WebhooksBatchRequest1
    {
