...
/**
 * Builder for model V1WebhooksContactRequest1
 *
 * @see V1WebhooksContactRequest1
 */
class V1WebhooksContactRequest1Builder
{
    /**
     * @var V1WebhooksContactRequest1
     */
    private $instance;

    private function __construct(V1WebhooksContactRequest1 $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new V1 Webhooks Contact Request 1 Builder object.
     */
    public static function init(): self
    {
        return new self(new V1WebhooksContactRequest1());
    }
    ...
    /**
     * Initializes a new V1 Webhooks Contact Request 1 object.
     */
    public function build(): V1WebhooksContactRequest1
    {
