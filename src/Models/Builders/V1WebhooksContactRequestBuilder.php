...
/**
 * Builder for model V1WebhooksContactRequest
 *
 * @see V1WebhooksContactRequest
 */
class V1WebhooksContactRequestBuilder
{
    /**
     * @var V1WebhooksContactRequest
     */
    private $instance;

    private function __construct(V1WebhooksContactRequest $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new V1 Webhooks Contact Request Builder object.
     *
     * @param bool $isActive
    ...
    public static function init(
        ...
        return new self(new V1WebhooksContactRequest(
            $isActive,
            $locationId,
            $onCreate,
            $onUpdate,
    ...
    /**
     * Initializes a new V1 Webhooks Contact Request object.
     */
    public function build(): V1WebhooksContactRequest
    {
