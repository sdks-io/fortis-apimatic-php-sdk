...
/**
 * Builder for model V1WebhooksTransactionRequest
 *
 * @see V1WebhooksTransactionRequest
 */
class V1WebhooksTransactionRequestBuilder
{
    /**
     * @var V1WebhooksTransactionRequest
     */
    private $instance;

    private function __construct(V1WebhooksTransactionRequest $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new V1 Webhooks Transaction Request Builder object.
     *
     * @param bool $isActive
    ...
    public static function init(
        ...
        return new self(new V1WebhooksTransactionRequest(
            $isActive,
            $locationId,
            $onCreate,
            $onUpdate,
     ...
     */
    public function format(?array $value): self
    {
    ...
    /**
     * Initializes a new V1 Webhooks Transaction Request object.
     */
    public function build(): V1WebhooksTransactionRequest
    {
