...
class CardholderAccount1 implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the CardholderAccount1 object to a human-readable string representation.
     *
     * @return string The string representation of the CardholderAccount1 object.
     */
    ...
    protected $propertyNames = ['expire_date', 'account_info', 'account_number', 'scheme_id', 'account_id', 'cvv'];
