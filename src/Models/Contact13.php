...
class Contact13 implements \JsonSerializable
{
    /**
     * @var array
     */
    ...
    /**
     * Converts the Contact13 object to a human-readable string representation.
     *
     * @return string The string representation of the Contact13 object.
     */
    ...
    protected $propertyNames = ['first_name', 'last_name', 'email', 'phone_number'];
