...
class Data2 implements \JsonSerializable
{
     ...
     * Returns Address.
     */
    public function getAddress(): ?Address4
    {
        return $this->address;
    }
     ...
     * @maps address
     */
    public function setAddress(?Address4 $address): void
    {
     ...
     * @maps user
     */
    public function setUser(?User9 $user): void
    {
        $this->user = $user;
    }
     ...
     * Returns Parent.
     */
    public function getParent(): ?Parent5
    {
        return $this->parent;
    }
     ...
     * @maps parent
     */
    public function setParent(?Parent5 $parent): void
    {
        $this->parent = $parent;
    }
     ...
     * Returns Children.
     */
    public function getChildren(): ?Children1
    {
     ...
     * @maps children
     */
    public function setChildren(?Children1 $children): void
    {
