...
class EmailBlacklist1 implements \JsonSerializable
{
    /**
     * @var array
     */
    ...
    /**
     * Converts the EmailBlacklist1 object to a human-readable string representation.
     *
     * @return string The string representation of the EmailBlacklist1 object.
     */
    ...
    protected $propertyNames = ['id', 'isBlacklisted', 'detail', 'created_ts'];
