...
class FilterBy implements \JsonSerializable
{
     ...
     * @required
     * @maps value
     * @mapsBy oneOf(float,anyOf(float,string,bool))
     *
     * @param float|string|bool $value
     */
    ...
    protected $propertyNames = ['key', 'operator', 'value'];
    ...
    public function jsonSerialize(bool $asArrayWhenEmpty = false)
    {
        $json = [];
        $json['key']      = $this->key;
        $json['operator'] = ApiHelper::getJsonHelper()->verifyTypes($this->operator, 'oneOf(Operator1)');
        $json['value']    =
            ApiHelper::getJsonHelper()->verifyTypes(
                $this->value,
                'oneOf(float,anyOf(float,string,bool))'
            );
