...
class Forecast1 implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the Forecast1 object to a human-readable string representation.
     *
     * @return string The string representation of the Forecast1 object.
     */
    ...
    protected $propertyNames = ['id', 'recurring_id', 'recurring_type', 'amount', 'month', 'created_ts', 'modified_ts'];
