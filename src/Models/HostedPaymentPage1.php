...
class HostedPaymentPage1 implements \JsonSerializable
{
    /**
     * @var array
     */
     ...
     */
    public function getFieldConfiguration(): ?FieldConfiguration2
    {
     ...
     */
    public function setFieldConfiguration(?FieldConfiguration2 $fieldConfiguration): void
    {
    ...
    /**
     * Converts the HostedPaymentPage1 object to a human-readable string representation.
     *
     * @return string The string representation of the HostedPaymentPage1 object.
     */
