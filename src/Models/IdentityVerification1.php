...
class IdentityVerification1 implements \JsonSerializable
{
    /**
     * @var array
     */
    ...
    /**
     * Converts the IdentityVerification1 object to a human-readable string representation.
     *
     * @return string The string representation of the IdentityVerification1 object.
     */
    ...
    protected $propertyNames = ['dl_state', 'dl_number', 'dob_year'];
