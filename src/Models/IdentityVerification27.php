 ...
 */
class IdentityVerification27 implements \JsonSerializable
{
    /**
     * @var string
     */
    ...
    /**
     * Converts the IdentityVerification27 object to a human-readable string representation.
     *
     * @return string The string representation of the IdentityVerification27 object.
     */
    ...
    protected $propertyNames = ['dl_state', 'dl_number', 'ssn4', 'dob_year'];
