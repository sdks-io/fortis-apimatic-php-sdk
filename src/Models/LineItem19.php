...
class LineItem19 implements \JsonSerializable
{
    /**
     * @var array
     */
     ...
     */
    public function getDebitCredit(): ?array
    {
     ...
     * @maps debit_credit
     */
    public function setDebitCredit(?array $debitCredit): void
    {
    ...
    /**
     * Converts the LineItem19 object to a human-readable string representation.
     *
     * @return string The string representation of the LineItem19 object.
     */
    ...
    public function jsonSerialize(bool $asArrayWhenEmpty = false)
    {
        ...
        if (isset($this->debitCredit)) {
            $json['debit_credit']     = $this->debitCredit;
        }
