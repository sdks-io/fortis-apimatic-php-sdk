...
class List5 implements \JsonSerializable
{
    ...
    /**
     * @var ProductAccountvault1|null
     */
    private $productAccountvault;

    /**
     * @var ProductToken1|null
     */
    private $productToken;

    /**
     * @var ProductRecurring1|null
     */
     ...
     */
    public function getProductFile(): ?ProductFile1
    {
     ...
     * @maps product_file
     */
    public function setProductFile(?ProductFile1 $productFile): void
    {
     ...
     */
    public function getProductAccountvault(): ?ProductAccountvault1
    {
     ...
     */
    public function setProductAccountvault(?ProductAccountvault1 $productAccountvault): void
    {
     ...
     */
    public function getProductToken(): ?ProductToken1
    {
     ...
     * @maps product_token
     */
    public function setProductToken(?ProductToken1 $productToken): void
    {
     ...
     */
    public function getProductRecurring(): ?ProductRecurring1
    {
     ...
     */
    public function setProductRecurring(?ProductRecurring1 $productRecurring): void
    {
