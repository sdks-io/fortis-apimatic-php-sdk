...
class LocationBillingAccount implements \JsonSerializable
{
    ...
    /**
     * Converts the LocationBillingAccount object to a human-readable string representation.
     *
     * @return string The string representation of the LocationBillingAccount object.
     */
