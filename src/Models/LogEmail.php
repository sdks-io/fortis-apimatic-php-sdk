...
class LogEmail implements \JsonSerializable
{
     ...
     */
    public function getReasonModel(): ?array
    {
     ...
     * @maps reason_model
     */
    public function setReasonModel(?array $reasonModel): void
    {
    ...
    /**
     * Converts the LogEmail object to a human-readable string representation.
     *
     * @return string The string representation of the LogEmail object.
     */
