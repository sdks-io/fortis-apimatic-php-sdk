...
class MessageExtension implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the MessageExtension object to a human-readable string representation.
     *
     * @return string The string representation of the MessageExtension object.
     */
    ...
    protected $propertyNames = ['id', 'name', 'criticality_indicator', 'data'];
