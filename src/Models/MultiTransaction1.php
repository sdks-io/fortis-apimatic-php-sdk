...
class MultiTransaction1 implements \JsonSerializable
{
    /**
     * @var MerchantList[]
     */
    ...
    /**
     * Converts the MultiTransaction1 object to a human-readable string representation.
     *
     * @return string The string representation of the MultiTransaction1 object.
     */
    ...
    protected $propertyNames = ['merchant_list', 'av_validity_time', 'av_number_use'];
