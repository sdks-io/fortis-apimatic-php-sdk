...
class PaymentRecurringNotification implements \JsonSerializable
{
    ...
    /**
     * Converts the PaymentRecurringNotification object to a human-readable string representation.
     *
     * @return string The string representation of the PaymentRecurringNotification object.
     */
