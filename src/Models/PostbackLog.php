...
class PostbackLog implements \JsonSerializable
{
     ...
     */
    public function getPostbackStatusId(): ?array
    {
     ...
     */
    public function setPostbackStatusId(?array $postbackStatusId): void
    {
    ...
    public function __toString(): string
    {
        return ApiHelper::stringify(
            'PostbackLog',
            [
                'postbackStatusId' => $this->postbackStatusId,
                'id' => $this->id,
    ...
    {
        $json = [];
        if (isset($this->postbackStatusId)) {
            $json['postback_status_id'] = $this->postbackStatusId;
        }
        if (isset($this->id)) {
            $json['id']                 = $this->id;
        }
