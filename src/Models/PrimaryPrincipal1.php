...
class PrimaryPrincipal1 implements \JsonSerializable
{
    ...
    /**
     * Converts the PrimaryPrincipal1 object to a human-readable string representation.
     *
     * @return string The string representation of the PrimaryPrincipal1 object.
     */
