...
class ProductInvoice1 implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the ProductInvoice1 object to a human-readable string representation.
     *
     * @return string The string representation of the ProductInvoice1 object.
     */
    public function __toString(): string
    {
        return ApiHelper::stringify(
            ...
            [
                'title' => $this->title,
                'quoteNumberFormat' => $this->getQuoteNumberFormat(),
                'quoteNumberStart' => $this->getQuoteNumberStart(),
                'quoteNumberIncrement' => $this->getQuoteNumberIncrement(),
                'quoteNumberCurrent' => $this->getQuoteNumberCurrent(),
                'invoiceNumberFormat' => $this->getInvoiceNumberFormat(),
                'invoiceNumberStart' => $this->getInvoiceNumberStart(),
                'invoiceNumberIncrement' => $this->getInvoiceNumberIncrement(),
                'invoiceNumberCurrent' => $this->getInvoiceNumberCurrent(),
                'taxRate' => $this->taxRate,
                'taxFee' => $this->getTaxFee(),
                'monthlyFee' => $this->getMonthlyFee(),
                'perInvoiceFee' => $this->perInvoiceFee,
                'perQuoteFee' => $this->perQuoteFee,
                'requirePayInFull' => $this->requirePayInFull,
