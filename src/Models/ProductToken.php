 ...
 * Product Token array
 */
class ProductToken implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the ProductToken object to a human-readable string representation.
     *
     * @return string The string representation of the ProductToken object.
     */
