...
class Purchase1 implements \JsonSerializable
{
    /**
     * @var int|null
     */
    ...
    /**
     * Converts the Purchase1 object to a human-readable string representation.
     *
     * @return string The string representation of the Purchase1 object.
     */
    ...
    public function jsonSerialize(bool $asArrayWhenEmpty = false)
    {
        ...
        if (isset($this->amountInd)) {
            $json['amount_ind']              = $this->amountInd;
        }
