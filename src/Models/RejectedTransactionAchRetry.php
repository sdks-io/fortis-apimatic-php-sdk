...
class RejectedTransactionAchRetry implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the RejectedTransactionAchRetry object to a human-readable string representation.
     *
     * @return string The string representation of the RejectedTransactionAchRetry object.
     */
