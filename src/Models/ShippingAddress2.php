...
class ShippingAddress2 implements \JsonSerializable
{
    /**
     * @var string|null
     */
     ...
     * The ISO 3166-1 alpha-3 or alpha-2 country of the Cardholder shipping address associated with the
    ...
    /**
     * Converts the ShippingAddress2 object to a human-readable string representation.
     *
     * @return string The string representation of the ShippingAddress2 object.
     */
