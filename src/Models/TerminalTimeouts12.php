 ...
 * >
 */
class TerminalTimeouts12 implements \JsonSerializable
{
    /**
     * @var array
     */
    private $cardEntryTimeout = [];

    /**
     * @var array
     */
    private $deviceTermsPromptTimeout = [];
     ...
     * @var array
     */
    private $pinEntryTimeout = [];

    /**
     * @var array
     */
    private $signatureInputTimeout = [];

    /**
     * @var array
     */
    private $signatureSubmitTimeout = [];

    /**
     * @var array
     */
    private $statusDisplayTime = [];

    /**
     * @var array
     */
    private $tipCashbackTimeout = [];
    ...
    /**
     * Converts the TerminalTimeouts12 object to a human-readable string representation.
     *
     * @return string The string representation of the TerminalTimeouts12 object.
     */
