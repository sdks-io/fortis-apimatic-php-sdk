...
class ThreeDsRequestor1 implements \JsonSerializable
{
    /**
     * @var string
     */
    ...
    /**
     * Converts the ThreeDsRequestor1 object to a human-readable string representation.
     *
     * @return string The string representation of the ThreeDsRequestor1 object.
     */
    ...
    {
        $json = [];
        $json['three_ds_requestor_authentication_ind']            = $this->threeDsRequestorAuthenticationInd;
        ...
        if (isset($this->threeDsRequestorChallengeInd)) {
            $json['three_ds_requestor_challenge_ind']             = $this->threeDsRequestorChallengeInd;
        }
        ...
        if (isset($this->threeDsRequestorDecReqInd)) {
            $json['three_ds_requestor_dec_req_ind']               = $this->threeDsRequestorDecReqInd;
        }
        ...
        if (isset($this->threeDsRequestorSpcSupport)) {
            $json['three_ds_requestor_spc_support']               = $this->threeDsRequestorSpcSupport;
        }
