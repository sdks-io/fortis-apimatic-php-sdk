...
class TipPercents1 implements \JsonSerializable
{
    /**
     * @var array
     */
    ...
    /**
     * Converts the TipPercents1 object to a human-readable string representation.
     *
     * @return string The string representation of the TipPercents1 object.
     */
    ...
    protected $propertyNames = ['percent_1', 'percent_2', 'percent_3'];
