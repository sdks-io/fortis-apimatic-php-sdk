...
class User4 implements \JsonSerializable
{
    /**
     * @var array
     */
    ...
    /**
     * Converts the User4 object to a human-readable string representation.
     *
     * @return string The string representation of the User4 object.
     */
    ...
    protected $propertyNames = ['id', 'username', 'first_name', 'last_name'];
