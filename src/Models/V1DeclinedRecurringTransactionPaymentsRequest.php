...
class V1DeclinedRecurringTransactionPaymentsRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the V1DeclinedRecurringTransactionPaymentsRequest object to a human-readable string
     * representation.
     *
     * @return string The string representation of the V1DeclinedRecurringTransactionPaymentsRequest object.
     */
    public function __toString(): string
    {
        return ApiHelper::stringify(
            ...
            [
                ...
                'tags' => $this->getTags(),
                'replaceAccountVault' => $this->replaceAccountVault,
