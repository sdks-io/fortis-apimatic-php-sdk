...
class V1FullboardingRequest implements \JsonSerializable
{
     ...
     */
    public function getPreferredLanguage(): ?array
    {
     ...
     */
    public function setPreferredLanguage(?array $preferredLanguage): void
    {
    ...
    /**
     * Converts the V1FullboardingRequest object to a human-readable string representation.
     *
     * @return string The string representation of the V1FullboardingRequest object.
     */
    public function __toString(): string
    {
        return ApiHelper::stringify(
            ...
            [
                ...
                'fedTaxId' => $this->fedTaxId,
                'averageTicket' => $this->averageTicket,
                'highTicket' => $this->highTicket,
                'ccMonthlyVolume' => $this->ccMonthlyVolume,
                'ecMonthlyVolume' => $this->getEcMonthlyVolume(),
                'mccCode' => $this->mccCode,
                'businessDescription' => $this->businessDescription,
                'swipedPercent' => $this->swipedPercent,
                'keyedPercent' => $this->keyedPercent,
                'ecommercePercent' => $this->ecommercePercent,
                'isForeignEntity' => $this->isForeignEntity,
                'personallyGuaranteed' => $this->personallyGuaranteed,
                'preferredLanguage' => $this->preferredLanguage,
                'addresses' => $this->addresses,
                'owners' => $this->owners,
                'bankAccounts' => $this->bankAccounts,
                'documents' => $this->documents,
                'pricingElements' => $this->pricingElements,
                'kycResponseObjects' => $this->kycResponseObjects,
                'metadata' => $this->metadata,
                'signerIp' => $this->getSignerIp(),
    ...
    public function jsonSerialize(bool $asArrayWhenEmpty = false)
    {
        ...
        if (isset($this->preferredLanguage)) {
            $json['preferred_language']   = $this->preferredLanguage;
        }
