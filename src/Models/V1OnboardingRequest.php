...
class V1OnboardingRequest implements \JsonSerializable
{
    ...
    /**
     * @var BankAccount3|null
     */
    private $bankAccount;

    /**
     * @var AltBankAccount2|null
     */
    ...
    /**
     * @param PrimaryPrincipal2 $primaryPrincipal
     * @param string $templateCode
     * @param string $email
     * @param string $dbaName
     * @param Location19 $location
     * @param string $appDelivery
     * @param Contact13 $contact
     */
     ...
     */
    public function getPrimaryPrincipal(): PrimaryPrincipal2
    {
     ...
     */
    public function setPrimaryPrincipal(PrimaryPrincipal2 $primaryPrincipal): void
    {
        $this->primaryPrincipal = $primaryPrincipal;
    }
     ...
     * Returns Location.
     */
    public function getLocation(): Location19
    {
     ...
     * @maps location
     */
    public function setLocation(Location19 $location): void
    {
        $this->location = $location;
    }
     ...
     */
    public function getBusinessCategory(): ?array
    {
     ...
     */
    public function setBusinessCategory(?array $businessCategory): void
    {
     ...
     */
    public function getOwnershipType(): ?array
    {
     ...
     * @maps ownership_type
     */
    public function setOwnershipType(?array $ownershipType): void
    {
     ...
     */
    public function getBankAccount(): ?BankAccount3
    {
     ...
     * @maps bank_account
     */
    public function setBankAccount(?BankAccount3 $bankAccount): void
    {
     ...
     */
    public function getAltBankAccount(): ?AltBankAccount2
    {
     ...
     */
    public function setAltBankAccount(?AltBankAccount2 $altBankAccount): void
    {
     ...
     * Returns Contact.
     */
    public function getContact(): Contact13
    {
        return $this->contact;
    }
     ...
     * @maps contact
     */
    public function setContact(Contact13 $contact): void
    {
        $this->contact = $contact;
    }
    ...
    public function jsonSerialize(bool $asArrayWhenEmpty = false)
    {
        ...
        if (isset($this->businessCategory)) {
            $json['business_category']       = $this->businessCategory;
        }
        ...
        if (isset($this->ownershipType)) {
            $json['ownership_type']          = $this->ownershipType;
        }
