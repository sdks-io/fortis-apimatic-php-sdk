...
class V1PaylinksRequest implements \JsonSerializable
{
    ...
    /**
     * Returns Amount Due.
     * This is the amount that need to be paid (automatically calculated by system). amount_due= sum of
     * items in item_list
     */
    ...
    /**
     * Returns Contact Id.
     * Include the Contact_id that the Paylink will belong to. This will allow you to query the List All
     * Paylinks and filter_by Contact_id to see the status of all the contacts Paylinks.
     */
     ...
     * ACH product transaction on which Paylink is created. This field is optional and will default to
     * default_ach product if not supplied at all. Either this or cc_product_transaction_id must be
     * supplied. Changes are allowed on PUT if payments have not been made against Paylink.
     */
    ...
    /**
     * Returns Cell Phone.
     * Required if delivery_method is set to 2[SMS], 3[Both email and sms], this will be the recipient of
     * the SMS
     */
    ...
    /**
     * Returns Store Token.
     * Store Token to create a token_id(account_vault_id) to be used for future payment types(CC Sale
     * Tokenized, ACH Debit Tokenized)
     */
    ...
    /**
     * Converts the V1PaylinksRequest object to a human-readable string representation.
     *
     * @return string The string representation of the V1PaylinksRequest object.
     */
