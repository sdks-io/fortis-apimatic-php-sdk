...
class V1TicketsRequest implements \JsonSerializable
{
     ...
     */
    public function getBillingAddress(): ?BillingAddress9
    {
     ...
     */
    public function setBillingAddress(?BillingAddress9 $billingAddress): void
    {
    ...
    /**
     * Converts the V1TicketsRequest object to a human-readable string representation.
     *
     * @return string The string representation of the V1TicketsRequest object.
     */
