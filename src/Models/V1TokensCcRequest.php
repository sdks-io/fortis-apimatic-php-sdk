...
class V1TokensCcRequest implements \JsonSerializable
{
     ...
     * @maps _joi
     */
    public function setJoi(?Joi19 $joi): void
    {
        $this->joi = $joi;
    }
    ...
    /**
     * Converts the V1TokensCcRequest object to a human-readable string representation.
     *
     * @return string The string representation of the V1TokensCcRequest object.
     */
