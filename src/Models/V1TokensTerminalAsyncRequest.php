...
class V1TokensTerminalAsyncRequest implements \JsonSerializable
{
    /**
     * @var array
     */
    ...
    /**
     * Converts the V1TokensTerminalAsyncRequest object to a human-readable string representation.
     *
     * @return string The string representation of the V1TokensTerminalAsyncRequest object.
     */
