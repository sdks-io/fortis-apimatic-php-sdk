...
class V1TokensTicketRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the V1TokensTicketRequest object to a human-readable string representation.
     *
     * @return string The string representation of the V1TokensTicketRequest object.
     */
