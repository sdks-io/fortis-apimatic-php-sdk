...
class V1TokensWalletRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the V1TokensWalletRequest object to a human-readable string representation.
     *
     * @return string The string representation of the V1TokensWalletRequest object.
     */
