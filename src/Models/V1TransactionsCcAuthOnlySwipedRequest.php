...
class V1TransactionsCcAuthOnlySwipedRequest implements \JsonSerializable
{
    /**
    ...
    /**
     * @var IdentityVerification1|null
     */
     ...
     */
    public function __construct(int $transactionAmount, string $trackData)
    {
     ...
     */
    public function getIdentityVerification(): ?IdentityVerification1
    {
     ...
     */
    public function setIdentityVerification(?IdentityVerification1 $identityVerification): void
    {
     ...
     * Returns Wallet Type.
     */
    public function getWalletType(): ?array
    {
     ...
     * @maps wallet_type
     */
    public function setWalletType(?array $walletType): void
    {
     ...
     */
    public function getInitiationType(): ?array
    {
     ...
     */
    public function setInitiationType(?array $initiationType): void
    {
    ...
    /**
     * Converts the V1TransactionsCcAuthOnlySwipedRequest object to a human-readable string representation.
     *
     * @return string The string representation of the V1TransactionsCcAuthOnlySwipedRequest object.
     */
    public function __toString(): string
    {
        return ApiHelper::stringify(
            ...
            [
                ...
                'initiationType' => $this->initiationType,
    ...
    public function jsonSerialize(bool $asArrayWhenEmpty = false)
    {
        ...
        if (isset($this->walletType)) {
            $json['wallet_type']                            = $this->walletType;
        }
        ...
        if (isset($this->initiationType)) {
            $json['initiation_type']                        = $this->initiationType;
        }
