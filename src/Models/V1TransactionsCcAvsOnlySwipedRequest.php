...
class V1TransactionsCcAvsOnlySwipedRequest implements \JsonSerializable
{
    /**
    ...
    /**
     * Converts the V1TransactionsCcAvsOnlySwipedRequest object to a human-readable string representation.
     *
     * @return string The string representation of the V1TransactionsCcAvsOnlySwipedRequest object.
     */
