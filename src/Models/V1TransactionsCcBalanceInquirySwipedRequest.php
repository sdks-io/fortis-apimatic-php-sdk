...
class V1TransactionsCcBalanceInquirySwipedRequest implements \JsonSerializable
{
    /**
     ...
     */
    public function __construct(string $trackData)
    {
    ...
    /**
     * Converts the V1TransactionsCcBalanceInquirySwipedRequest object to a human-readable string
     * representation.
     *
     * @return string The string representation of the V1TransactionsCcBalanceInquirySwipedRequest object.
     */
