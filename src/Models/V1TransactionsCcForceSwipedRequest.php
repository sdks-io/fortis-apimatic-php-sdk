...
class V1TransactionsCcForceSwipedRequest implements \JsonSerializable
{
    /**
     ...
     */
    public function __construct(string $trackData, string $authCode)
    {
    ...
    /**
     * Converts the V1TransactionsCcForceSwipedRequest object to a human-readable string representation.
     *
     * @return string The string representation of the V1TransactionsCcForceSwipedRequest object.
     */
