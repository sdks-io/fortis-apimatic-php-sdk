...
class V1TransactionsCcRefundSwipedRequest implements \JsonSerializable
{
    /**
    ...
    /**
     * Converts the V1TransactionsCcRefundSwipedRequest object to a human-readable string representation.
     *
     * @return string The string representation of the V1TransactionsCcRefundSwipedRequest object.
     */
