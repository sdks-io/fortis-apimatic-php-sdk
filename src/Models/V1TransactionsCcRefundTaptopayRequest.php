...
class V1TransactionsCcRefundTaptopayRequest implements \JsonSerializable
{
     ...
     */
    public function __construct(string $cardDataCryptogram, string $generalCardData)
    {
    ...
    {
        if (count($this->cardReaderId) == 0) {
            return null;
        }
        return $this->cardReaderId['value'];
    }
    ...
    {
        $this->cardReaderId['value'] = $cardReaderId;
    }

    /**
     * Unsets Card Reader Id.
     * Identifier of card reader used in Tap to Pay transactions.
     */
    public function unsetCardReaderId(): void
    {
        $this->cardReaderId = [];
    }
    ...
    public function __toString(): string
    {
        return ApiHelper::stringify(
            ...
            [
                ...
                'cardReaderId' => $this->getCardReaderId(),
    ...
    public function jsonSerialize(bool $asArrayWhenEmpty = false)
    {
        ...
        if (!empty($this->cardReaderId)) {
            $json['card_reader_id']                         = $this->cardReaderId['value'];
        }
