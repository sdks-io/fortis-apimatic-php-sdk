...
class V1TransactionsCcSaleSwipedRequest implements \JsonSerializable
{
    /**
    ...
    /**
     * Converts the V1TransactionsCcSaleSwipedRequest object to a human-readable string representation.
     *
     * @return string The string representation of the V1TransactionsCcSaleSwipedRequest object.
     */
